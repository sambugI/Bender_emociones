...
class EmotionPublisherNode(Node):
    def __init__(self):
        ...
        self.emotions = {
            ...
            "rainbow": [[10.62, 62.70, 219.73]],
            "masbrillo": [[10.62, 62.70, 219.73]],
            "menosbrillo": [[10.62, 62.70, 219.73]],
            "brillo": [[10.62, 62.70, 219.73]],
            "tristeza": [[10.62, 79.10, 206.25]],
            "enojo": [[10.62, 74.12, 210.94]],
            "no": [
                [0.00, 62.70, 219.73],
                [21.00, 62.70, 219.73],
            ],
